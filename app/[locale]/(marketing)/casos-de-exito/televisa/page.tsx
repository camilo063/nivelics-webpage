...
export const metadata: Metadata = {
  title: "Caso de Éxito Televisa N+ | Nivelics",
  description:
...
export default function TelevisaPage() {
  const breadcrumb = getBreadcrumbSchema([
    { name: "Inicio", url: "/" },
    { name: "Casos de Éxito", url: "/casos-de-exito" },
    { name: "Televisa / N+", url: "/casos-de-exito/televisa" },
  ]);
      ...
      <section className="py-16 md:py-24">
        <div className="mx-auto max-w-[1280px] px-6 md:px-20">
          ...
          <div className="flex flex-wrap items-center gap-3 mb-6">
            ...
            <span className="text-sm text-text-40">México &middot; Medios / Streaming</span>
          </div>

          <h1 className="text-4xl font-bold text-text-100 md:text-5xl">
            Televisa / N+: Plataforma de Noticias Digitales
          </h1>
        </div>
      </section>
          ...
          <div className="grid gap-12 md:grid-cols-2">
            <div>
              ...
              <p className="mt-4 text-text-70 leading-relaxed">
                Televisa necesitaba una plataforma digital de noticias tipo streaming para el
                mercado hispanohablante, capaz de manejar picos masivos de tráfico durante eventos
                noticiosos en vivo.
              </p>
            </div>
            <div>
              ...
              <p className="mt-4 text-text-70 leading-relaxed">
                Diseñamos una arquitectura cloud escalable en AWS con CDN global, equipo de
                ingeniería Nivelics integrado al equipo Televisa, y pipelines de CI/CD para deploys
                múltiples al día.
              </p>
            </div>
          </div>
