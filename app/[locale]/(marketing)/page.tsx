                ...
                return (
                  ...
                  >
                    <div>
                      ...
                      <p className="mt-1 text-[13px] text-white/60 line-clamp-1">{resultLabel}</p>
                      {firstMetric ? (
              ...
              <div>
                ...
                {home.mapMetrics.length > 0 ? (
                  <div className="mt-8 grid grid-cols-2 gap-4">
                    {home.mapMetrics.map((m) => (
                      <div
                        key={m.label}
                        className="rounded-xl border border-primary/15 bg-white/[0.03] p-5 text-center"
                      >
                        <data value={m.value} className="font-mono text-4xl font-bold text-primary">
                          {m.value}
                        </data>
