          ...
          {dbContent ? (
            ...
            <>
              ...
              <p className="mt-6 text-text-70 leading-relaxed">
                En Nivelics SAS (en adelante &quot;Nivelics&quot;), con domicilio en Bogotá,
                Colombia, nos comprometemos a proteger la privacidad y los datos personales de
                nuestros usuarios, clientes y visitantes. Esta política describe cómo recopilamos,
              ...
              <div className="mt-12 space-y-10">
                ...
                <div>
                  ...
                  <div className="mt-4 space-y-3 text-text-70 leading-relaxed">
                    ...
                    <ul className="list-disc space-y-2 pl-6">
                      ...
                      <li>
                        <strong className="text-text-100">Datos de navegación:</strong> dirección
                        IP, tipo de navegador, páginas visitadas, tiempo de permanencia y datos de
                        cookies.
                      </li>
                      <li>
                        <strong className="text-text-100">Datos de formularios:</strong> información
                        proporcionada voluntariamente a través de formularios de contacto,
                        solicitudes de empleo o suscripciones.
                      </li>
                      <li>
                ...
                <div>
                  ...
                  <div className="mt-4 space-y-3 text-text-70 leading-relaxed">
                    ...
                    <ul className="list-disc space-y-2 pl-6">
                      <li>
                        <strong className="text-text-100">Cookies esenciales:</strong> necesarias
                      ...
                      <li>
                        <strong className="text-text-100">Cookies de preferencias:</strong>{" "}
                        recuerdan sus preferencias de idioma y tema.
                      </li>
                    </ul>
                    <p>
                      Puede configurar su navegador para rechazar cookies o recibir una notificación
                      cuando se envíe una cookie. Sin embargo, algunas funcionalidades del sitio
                      pueden no estar disponibles si las cookies están deshabilitadas.
                    </p>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="mt-4 space-y-3 text-text-70 leading-relaxed">
                    ...
                    <ul className="list-disc space-y-2 pl-6">
                      <li>
                        <strong className="text-text-100">Acceso:</strong> conocer qué datos
                        personales tenemos sobre usted.
                      </li>
                      <li>
                      ...
                      <li>
                        <strong className="text-text-100">Supresión:</strong> solicitar la
                        eliminación de sus datos cuando no sean necesarios para la finalidad para la
                        cual fueron recopilados.
                      </li>
                      <li>
                        <strong className="text-text-100">Revocación:</strong> revocar el
                ...
                <div>
                  ...
                  <div className="mt-4 space-y-3 text-text-70 leading-relaxed">
                    <p>
                      ...
                      derechos, puede contactarnos:
                    </p>
                    <ul className="list-disc space-y-2 pl-6">
                      <li>
                        <strong className="text-text-100">Responsable del tratamiento:</strong>{" "}
                        Nivelics SAS
                      </li>
                      <li>
