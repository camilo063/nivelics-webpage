      ...
      <section className="py-16 md:py-24">
        <div className="mx-auto max-w-[1280px] px-6 md:px-20">
          <div className="grid gap-12 lg:grid-cols-2">
            {/* Info */}
            <div>
              <h1 className="text-4xl font-bold text-text-100 md:text-5xl">Hablemos</h1>
              <p className="mt-4 text-lg text-text-70">
                Cuéntanos sobre tu proyecto o desafío tecnológico y te contactamos en menos de 24
                horas.
              </p>
