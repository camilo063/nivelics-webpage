  ...
  return (
    <PageWrapper>
      ...
      <HeroSplit
        ...
        subtitle="Segmentación dinámica, campañas personalizadas 1:1 y análisis predictivo integrado con tu CRM. Cada lead recibe el mensaje correcto en el momento correcto."
        bullets={[
      ...
      <MetricsBar
        metrics={[
          ...
          { value: "100%", label: "Sync con CRM", sublabel: "datos actualizados en tiempo real" },
        ]}
      />
