// Ingeniería de agentes a la medida — servicio insignia de la línea de agentes (antes «Agentes de IA»).
...
export async function generateMetadata({
  ...
  return agentServiceMetadata("agentesIa", locale);
}
...
export default async function AgentesIAPage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  setRequestLocale(__locale);
  const locale = (await getLocale()) as Locale;
  return <AgentServicePage serviceKey="agentesIa" locale={locale} />;
}
