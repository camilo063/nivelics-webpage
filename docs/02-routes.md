...
| `/servicios/inteligencia-artificial/integracion-sistemas-mcp`  | `/en/services/artificial-intelligence/systems-integration-mcp` |
| `/servicios/inteligencia-artificial/ia-privada-on-premise`     | `/en/services/artificial-intelligence/private-ai-on-premises`  |
| `/servicios/inteligencia-artificial/agentops-gobierno-agentes` | `/en/services/artificial-intelligence/agentops`                |
