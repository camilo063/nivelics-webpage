  ...
  return (
    <section className="relative overflow-hidden bg-[#0A0A0F] pt-20 pb-24 md:pt-28 md:pb-32">
      ...
      <div className="relative mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p className="mx-auto mt-6 max-w-2xl text-lg text-white/70 md:text-xl">{subtitle}</p>
        ...
        <div className="mt-10 flex flex-col items-center justify-center gap-3 sm:flex-row">
          ...
          {ctaSecondary && (
            <Link
              ...
              className="flex min-h-[52px] cursor-pointer items-center justify-center rounded-full border border-white/30 px-6 py-3 text-base font-medium text-white/80 transition-all duration-150 hover:border-white/60 hover:bg-white/5 hover:text-white"
            >
              {ctaSecondary.text}
            </Link>
          )}
        ...
        {trustBadge && <p className="mt-8 text-sm text-white/50">{trustBadge}</p>}
      </div>
    </section>
  );
}
