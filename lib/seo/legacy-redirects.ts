...
export const LEGACY_REDIRECTS: { source: string; destination: string; permanent: true }[] = [
  { source: "/en/contact-us-at", destination: "/en/contact", permanent: true },
  { source: "/en/blogs", destination: "/en/blog", permanent: true },
  {
